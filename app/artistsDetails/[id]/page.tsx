      ...
      <div className="relative h-96 w-full">
        ...
        <div className="absolute bottom-0 left-0 right-0 p-8 max-w-7xl mx-auto">
          ...
          <div className="flex items-center space-x-6 text-white/90">
            <span className="text-lg">{artist.songCount} songs in TOP2000</span>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
          ...
          <div className="lg:col-span-2">
            ...
            <div className="bg-white rounded-xl shadow-sm p-8">
              <h2 className="text-2xl font-bold mb-6 text-gray-900">Songs in TOP2000</h2>
            ...
            <div className="bg-white rounded-xl shadow-sm p-6 sticky top-8">
              ...
              <dl className="space-y-4">
                <div className="flex justify-between py-3 border-b border-gray-100">
                  <dt className="text-gray-500">Total Songs</dt>
                  <dd className="font-medium text-gray-900">{artist.songCount}</dd>
                </div>
                <div className="flex justify-between py-3 border-b border-gray-100">
                  <dt className="text-gray-500">Highest Rank</dt>
                  <dd className="font-medium text-gray-900">
                    #{Math.min(...songs.map(s => s.history[0]?.rank || 9999))}
                  </dd>
                </div>
                <div className="flex justify-between py-3 border-b border-gray-100">
                  <dt className="text-gray-500">Oldest Song</dt>
                  <dd className="font-medium text-gray-900">
                    {Math.min(...songs.map(s => s.year))}
                  </dd>
                </div>
                <div className="flex justify-between py-3 border-b border-gray-100">
                  <dt className="text-gray-500">Newest Song</dt>
                  <dd className="font-medium text-gray-900">
